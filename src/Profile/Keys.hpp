...
constexpr std::string_view AirspaceFile = "AirspaceFile"; // pL // TODO remove
constexpr std::string_view AirspaceFiles = "AirspaceFiles"; // pL
constexpr std::string_view AdditionalAirspaceFile = "AdditionalAirspaceFile"; // pL // TODO remove
